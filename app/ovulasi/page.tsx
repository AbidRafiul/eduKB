      ...
      <div className="bg-teal-700 text-white pt-10 pb-20 px-4 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-lg text-teal-100 max-w-2xl">
            Bantu memperkirakan hari ovulasi dan masa subur Anda berdasarkan HPHT
            dan rata-rata panjang siklus haid.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-slate-100">
          ...
          >
            <div className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">
                  Rata-rata Panjang Siklus Haid (hari)
                </label>
                <input
                  type="number"
                  min={21}
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Umumnya antara 21–35 hari, paling sering 28 hari.
                </p>
              </div>
              ...
              <div className="flex items-start gap-2 text-xs text-slate-600 bg-teal-50/70 border border-teal-100 rounded-xl p-3">
                ...
                <p>
                  Hasil ini hanya perkiraan berdasarkan metode kalender, bukan
                  alat diagnosis. Siklus yang tidak teratur, stres, dan kondisi
                  medis tertentu dapat mengubah waktu ovulasi.
                </p>
              </div>
            </div>
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 rounded-xl bg-white border border-teal-100 shadow-sm">
                    ...
                    <p className="font-semibold text-slate-800">
                      {formatTanggal(hasil.fertileStart)} s/d{" "}
                      {formatTanggal(hasil.fertileEnd)}
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-white border border-emerald-100 shadow-sm">
                    ...
                    <p className="font-semibold text-slate-800">
                      {formatTanggal(hasil.ovulationDate)}
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-white border border-slate-200 shadow-sm">
                    ...
                    <p className="font-semibold text-slate-800">
                      {formatTanggal(hasil.nextPeriod)}
                    </p>
                  </div>

                  <p className="mt-4 text-xs text-slate-500 leading-relaxed text-justify">
                    Untuk <span className="font-semibold text-slate-700">menghindari kehamilan</span>{" "}
                    dengan metode kalender, dianjurkan tidak melakukan hubungan
                    seksual tanpa pengaman pada rentang masa subur di atas. Jika{" "}
                    <span className="font-semibold text-slate-700">sedang merencanakan kehamilan</span>,
                    justru disarankan berhubungan pada rentang hari tersebut.
                  </p>
                </div>
              ) : (
